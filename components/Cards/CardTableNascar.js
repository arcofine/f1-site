...
export default function CardTable({color, data, driversNascar}) {
       ...
       const dataType = driversNascar ? DRIVERS : "";
                                          ...
                                          <div className="flex flex-wrap items-center">
                                                 <div className="relative w-full px-4 max-w-full flex-grow flex-1">
                                                        <h3
                                                               ...
                                                               {driversNascar
                                                                      ? "Classement de Pilotes Nastruck"
