...
export default function CardTable({color, data, driversPorsche}) {
       ...
       const dataType = driversPorsche ? DRIVERS : "";
                                          ...
                                          <div className="flex flex-wrap items-center">
                                                 <div className="relative w-full px-4 max-w-full flex-grow flex-1">
                                                        <h3
                                                               ...
                                                               {driversPorsche
                                                                      ? "Classement de Pilotes Porsche Cup"
