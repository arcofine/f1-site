...
import CardTable from "../../components/Cards/CardTableNascar.js";

// layout for page

import Admin from "../../layouts/Admin.js";

export default function TablesNascar({championship, error}) {
       return (
              <>
                            ...
                            {!error && (
                                   <>
                                          <div className="w-full mb-12 px-4">
                                                 <CardTable  data={championship} color="dark" driversNascar/>
                                          </div>
...
export async function getServerSideProps({
       ...
       try {
              const data = await fetch("https://f1sim-wiget-m4.vercel.app/championships/export_standings_json.json?cid=1");
